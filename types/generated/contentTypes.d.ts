...
export interface ApiCategoriaCategoria extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    macrocategoria: Attribute.Relation<
      'api::categoria.categoria',
      'manyToOne',
      'api::macrocategoria.macrocategoria'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiListaDeseoListaDeseo extends Schema.CollectionType {
  ...
  attributes: {
    nombre: Attribute.String &
      ...
      Attribute.DefaultTo<'Mi Lista de Deseos'>;
    descripcion: Attribute.Text;
...
export interface ApiMacrocategoriaMacrocategoria extends Schema.CollectionType {
...
export interface ApiPedidoPedido extends Schema.CollectionType {
  ...
  attributes: {
    ...
    fecha_emision: Attribute.DateTime & Attribute.Required;
    fecha_finalizacion: Attribute.DateTime;
    direccion: Attribute.Text &
      Attribute.SetMinMaxLength<{
        maxLength: 100;
      }>;
    metodo_envio: Attribute.Enumeration<
      ['Retiro en tienda', 'Despacho a domicilio']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'Retiro en tienda'>;
    users_permissions_user: Attribute.Relation<
      'api::pedido.pedido',
      'manyToOne',
      'plugin::users-permissions.user'
...
export interface ApiProductoProducto extends Schema.CollectionType {
  ...
  attributes: {
    ...
    stock: Attribute.Integer &
      ...
      Attribute.DefaultTo<0>;
    es_despachable: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    ...
    subcategoria: Attribute.Relation<
      ...
      'api::subcategoria.subcategoria'
    >;
    lista_deseos: Attribute.Relation<
      'api::producto.producto',
      'manyToMany',
      'api::lista-deseo.lista-deseo'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::macrocategoria.macrocategoria': ApiMacrocategoriaMacrocategoria;
